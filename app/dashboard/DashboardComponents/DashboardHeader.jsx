...
const items = [
  ...
  { name: "Notice", href: "/dashboard/notice" },
  { name: "Class", href: "/dashboard/class" },
  { name: "Event", href: "/dashboard/event" },
  { name: "Video", href: "/dashboard/video" },
  { name: "Photo", href: "/dashboard/photo" },
  { name: "Group", href: "/dashboard/group" },
  { name: "Feedback", href: "/dashboard/feedback" },
  { name: "Donation", href: "/dashboard/donation" },
  { name: "Message", href: "/dashboard/message" },
  { name: "Notification", href: "/dashboard/notification" },
];

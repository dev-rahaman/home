...
const FeedHeader = () => {
  ...
  return (
    <div className="relative">
      <nav className="z-50 w-full sticky bg-[#0E6C14] text-white top-0 border-gray-200 dark:bg-gray-900">
        <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
          ...
          <div class="flex md:order-2">
            <button
              ...
              aria-expanded="false"
              class="md:hidden text-black hover:bg-gray-100 dark:hover:bg-gray-700 focus:outline-none focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 rounded-lg text-sm p-2.5 me-1"
            >
              <svg
                class="w-5 h-5"
                aria-hidden="true"
            ...
            <div className="end-3 ms-2">
              <button
                onClick={handleDropdown}
                className="p-[5px] text-white bg-gray-700 rounded flex items-center justify-between w-full"
              >
                Select <DropdownIcon />
              </button>
            </div>
            {open && (
              <ul className="w-[150px] h-[150px] z-50 space-y-4 bg-red-400 p-3 rounded absolute right-6  top-[52px]">
                <li>
                  <a
                    href="#"
                    class="text-black hover:text-blue-600 dark:hover:text-blue-500"
                  >
                    About Us
                  </a>
                </li>
          ...
          data-collapse-toggle="navbar-search"
          type="button"
          class="inline-flex items-center p-2 w-10 h-10 justify-center text-sm text-blacken hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600"
          aria-controls="navbar-search"
          aria-expanded="false"
        >
